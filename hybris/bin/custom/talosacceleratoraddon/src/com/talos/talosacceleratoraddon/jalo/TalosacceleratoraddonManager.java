 ...
 */
package com.talos.talosacceleratoraddon.jalo;
...
/**
 * This is the extension manager of the Talosacceleratoraddon extension.
 */
public class TalosacceleratoraddonManager extends GeneratedTalosacceleratoraddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TalosacceleratoraddonManager.class.getName());
	 ...
	 */
	public static TalosacceleratoraddonManager getInstance()
	{
		return (TalosacceleratoraddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TalosacceleratoraddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TalosacceleratoraddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TalosacceleratoraddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TalosacceleratoraddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TalosacceleratoraddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
