...
<ul class="checkout-order-summary-list tc-os-list">
    <c:if test="${hasShippedItems}">
        <li class="checkout-order-summary-list-heading tc-os-heading">
            <c:choose>
        ...
        <c:if test="${entry.deliveryPointOfService == null}">
            ...
            <li class="checkout-order-summary-list-items tc-os-product-container">
                ...
                <div class="details tc-os-product-details">
                    ...
                    <div class="qty"><span><spring:theme code="basket.page.quantity"/>:&nbsp;</span>${entry.quantity}</div>
                    <div>
                ...
                <div class="price tc-os-product-total-price"><format:price priceData="${entry.totalPrice}" displayFreeForZero="true"/></div>
