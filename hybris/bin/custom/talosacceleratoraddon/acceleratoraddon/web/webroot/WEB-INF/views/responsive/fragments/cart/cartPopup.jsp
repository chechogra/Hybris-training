...
<div class="tc-mini-cart js-mini-cart">
            ...
            <c:choose>
                <c:when test="${numberShowing > 0 }">
                        ...
                        <c:forEach items="${entries}" var="entry" end="${numberShowing - 1}">
                            ...
                            <li class="mini-cart-item">
                                ...
                                <div class="details">
                                    ...
                                    <div class="price"><span><spring:theme code="popup.item.price"/></span>&nbsp;<format:price priceData="${entry.basePrice}"/></div>
                                            ...
                                            <c:if test="${baseOptionQualifier.qualifier eq 'style' and not empty baseOptionQualifier.image.url}">
                                                <div class="itemColor">
                                                    ...
                                                    <img src="${baseOptionQualifier.image.url}"
                                                         alt="${fn:escapeXml(baseOptionQualifier.value)}"
                                                         title="${fn:escapeXml(baseOptionQualifier.value)}"/>
                                                </div>
                                            </c:if>
                                ...
                                <div class="totalPrice"><format:price priceData="${entry.totalPrice}"/></div>
                            </li>
                        </c:forEach>
                    </ol>
                    ...
                    <div class="mini-cart-totals">
                        <div class="key"><spring:theme code="basket.page.totals.total"/></div>
                        <div class="value"><format:price priceData="${cartData.totalPrice}"/></div>
                    </div>
                    <div class="tc-atc-buttons-container">
                ...
                <c:otherwise>
                    ...
                    <div class="tc-atc-buttons-container">
                        <button class="btn btn-primary btn-block tc-checkout-disabled-button" disabled="disabled">
                            <spring:theme code="${miniCartProceed }"/>
                        </button>
                        <a href="" class="btn btn-default btn-block js-mini-cart-close-button">
