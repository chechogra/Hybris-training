...
<%@ taglib prefix="multiCheckout" tagdir="/WEB-INF/tags/addons/talosacceleratoraddon/responsive/checkout/multi" %>
...
<template:page pageTitle="${pageTitle}">
    <div class="container-fluid tc-container">
        <div class="row">
            <div class="col-sm-6">
                <div class="checkout-headline tc-checkout-step-headline">
                ...
                <multiCheckout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
                    <jsp:body>
                        <c:if test="${not empty paymentFormUrl}">
                            <div class="checkout-paymentmethod tc-checkout-step-container">
                                <div class="checkout-indent">

                                    <div class="headline tc-checkout-current-step-title"><spring:theme text="Payment"/></div>

                                    <ycommerce:testId code="paymentDetailsForm">

                                        <form:form id="silentOrderPostForm" name="silentOrderPostForm"
                                                   commandName="sopPaymentDetailsForm" action="${paymentFormUrl}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <c:if test="${not empty paymentInfos}">
                                                    <button type="button" class="btn btn-default btn-block js-tc-saved-payments">
                                                        <spring:theme
                                                                code="checkout.multi.paymentMethod.addPaymentDetails.useSavedCard"/></button>
                                                </c:if>
                                            </div>

                                            <div class="form-group">
                                                <formElement:formSelectBox idKey="card_cardType" labelKey="payment.cardType.pleaseSelect"
                                                                           path="card_cardType" selectCSSClass="form-control"
                                            ...
                                            <div class="form-group">
                                                <formElement:formInputBox idKey="card_nameOnCard" labelKey="payment.nameOnCard"
                                                                          path="card_nameOnCard" inputCSS="form-control"
                                                                          tabindex="2"
                                                                          mandatory="false"/>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <formElement:formInputBox idKey="card_accountNumber" labelKey="payment.cardNumber"
                                                                          path="card_accountNumber" inputCSS="form-control"
                                                                          mandatory="true" tabindex="3" autocomplete="off"/>
                                            </div>

                                            <fieldset id="startDate" class="tc-clean">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <formElement:formSelectBox idKey="StartYear" selectCSSClass="form-control"
                                                                                   ...
                                                                                   items="${startYears}" tabindex="7"/>
                                                    </div>
                                                </div>
                                            </fieldset>


                                            <fieldset id="cardDate" class="tc-clean">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <formElement:formInputBox idKey="card_cvNumber" labelKey="payment.cvn"
                                                                              path="card_cvNumber" inputCSS="form-control"
                                                ...
                                                <div class="col-xs-6">
                                                    <div id="issueNum">
                                                        <formElement:formInputBox idKey="card_issueNumber"
                                                                                  ...
                                                                                  path="card_issueNumber" inputCSS="text"
                                                                                  mandatory="false" tabindex="9"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="headline tc-checkout-current-step-title">
                                                <spring:theme
                                            ...
                                            <p class="help-block tc-checkout-"><spring:theme
                            ...
                            <div id="savedpayments">
                                ...
                                <div id="savedpaymentsbody">
                                    <c:forEach items="${paymentInfos}" var="paymentInfo" varStatus="status">
                                        <div class="saved-payment-entry tc-saved-info-container">
                                            <form action="${request.contextPath}/checkout/multi/payment-method/choose"
                                                  method="GET">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-block"
                                                        tabindex="${(status.count * 2) - 1}"><spring:theme
