...
<%@ taglib prefix="pagination" tagdir="/WEB-INF/tags/addons/talosacceleratoraddon/responsive/nav/pagination" %>
                    ...
                    <div class="row">
                        ...
                        <c:if test="${not hideRefBtn}">
                            <div class="col-xs-12 col-sm-3 col-md-4 hidden-md hidden-lg">
                                <div class="tc-refine-btn">
                                    <ycommerce:testId code="searchResults_refine_button">
                                        <product:productRefineButton styleClass="btn btn-primary btn-block js-tc-show-facets"/>
                                    </ycommerce:testId>
                                </div>
                            </div>
                        </c:if>

                        <div class="col-xs-12 col-sm-5 col-md-6 col-lg-8 pagination-wrap">
                            <div class="tc-pagination-wp">
