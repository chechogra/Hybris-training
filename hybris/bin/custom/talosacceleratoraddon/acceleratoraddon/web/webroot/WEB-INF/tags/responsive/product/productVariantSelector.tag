    ...
    <c:otherwise>
        ...
        <c:if test="${not empty variantStyles or not empty variantSizes}">
            ...
            <div class="variant-section">
                <c:if test="${not empty variantStyles}">
                    <div class="variant-selector">
                        <div class="variant-name">
                            <spring:theme code="product.variants.choose"/>&nbsp;<spring:theme code="product.variants.colour"/>
                        </div>
                        <ul class="variant-list">
                ...
                <c:if test="${not empty variantSizes}">
                    <div class="variant-selector">
                            <div class="variant-name">
                                <spring:theme code="product.variants.choose"/>&nbsp;<spring:theme code="product.variants.size"/>
                                ...
                                <c:forEach items="${variantSizes}" var="variantSize">
                                    ...
                                    <c:forEach items="${variantSize.variantOptionQualifiers}" var="variantOptionQualifier">
                                        <c:if test="${variantOptionQualifier.qualifier eq 'size'}">
                                            ...
                                            <c:set var="optionsString">${variantOptionQualifierValue}</c:set>
                                    ...
                                    <li class="size-option ${(variantSize.url eq product.url) ? 'active' : ''}" >
                                        <a href="${variantOptionUrl}">
                                            ${optionsString}
                                        </a>
                                    </li>
                                </c:forEach>
        ...
        <c:if test="${not empty variantOptions}">
            <div class="variant-section">
                <div class="variant-selector">
                    <div class="variant-name">
                        <spring:theme code="product.variants.choose"/>&nbsp;<spring:theme code="product.variants.type"/>
                    </div>
                    <ul class="variant-list">
                        <c:forEach items="${variantOptions}" var="variantOption">
                            ...
                            <li class="generic-option ${(variantOption.url eq product.url) ? 'active' : ''}" >
                                <a href="${variantOptionUrl}">
                                    ${nameString}<br><format:price priceData="${variantOption.priceData}"/>
                                </a>
                            </li>
                        </c:forEach>
                    </ul>
