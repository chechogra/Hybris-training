...
<c:if test="${not empty entry}">
    ...
    <li class="item__list--item">
        ...
        <div class="hidden-xs  item__toggle">
                    ...
                    <div class="hidden-xs ">
                        ...
                        <c:if test="${not empty entry.configurationInfos}">
                            <div class="item__configurations--edit">
                                <a class="btn" href="${entryConfigUrl}"><spring:theme
        ...
        <div class="item__quantity hidden-xs ">
            <c:choose>
                <c:when test="${not entry.product.multidimensional}">
                    ...
                    <form:form id="updateCartForm${entryNumber}" action="${cartUpdateFormAction}" method="post"
                        ...
                        <ycommerce:testId code="cart_product_quantity">
                            <form:label cssClass="visible-xs " path="quantity"
                                        for="quantity${entry.entryNumber}"></form:label>
                            <div class="tc-quick-qty-input-wp tc-input-qty-cart">
                                <button type="button" class="tc-square-button tc-qty-selector-minus hidden-xs hidden-sm">
                                ...
                                <form:input cssClass="form-control js-update-entry-quantity-input"
                                            disabled="${not entry.updateable}"
                                            type="text" size="1" id="quantity_${entryNumber}" path="quantity"/>
                                <button type="button" class="tc-square-button tc-qty-selector-plus hidden-xs hidden-sm">
                                    <svg class="icon icon-minus">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <c:otherwise>
                    ...
                    <form:form id="updateCartForm${entryNumber}" action="${cartUpdateMultiDFormAction}" method="post"
                               class="js-qty-form${entryNumber}" commandName="updateQuantityForm${entryNumber}">
                        <input type="hidden" name="entryNumber" value="${entry.entryNumber}"/>
                        <input type="hidden" name="productCode" value="${fn:escapeXml(entry.product.code)}"/>
                        <input type="hidden" name="initialQuantity" value="${entry.quantity}"/>
                        <label class="visible-xs "><spring:theme code="basket.page.qty"/>:</label>
            ...
            <c:if test="${entry.updateable}">
                <div class="btn-group">
                    <button type="button" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false" id="editEntry_${entryNumber}">
                        <svg class="icon icon-show-more">
                            <use xlink:href="${symbolDefsPath}#icon-show-more"></use>
                        </svg>
                    </button>
        ...
        <div class="item__quantity__total visible-xs ">
            <c:if test="${entry.product.multidimensional}">
                <ycommerce:testId code="cart_product_updateQuantity">
                    <c:set var="showEditableGridClass" value="js-show-editable-grid"/>
                </ycommerce:testId>
            </c:if>
            <div class="details ${showEditableGridClass}" data-index="${index}"
                                ...
                                <ycommerce:testId code="cart_product_quantity">
                                    ...
                                    <div class="tc-quick-qty-input-wp tc-input-qty-cart">
                                        ...
                                        <form:input cssClass="form-control js-update-entry-quantity-input"
                                                    ...
                                                    id="quantity_${entryNumber}" path="quantity"/>
    ...
    <%--UNCOMMENT TO ENABLE MULT D PRODUCTS--%>
    <li>
