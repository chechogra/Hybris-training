...
<div class="subtotals ${subtotalsCssClasses} ">
    <div class="tc-os-subtotals-container">
        <div class="subtotal tc-os-subtotal">
        ...
        <c:if test="${cartData.totalDiscounts.value > 0}">
            <div class="subtotals__item--state-discount tc-os-subtotal-discount">
        ...
        <c:if test="${not empty cartData.deliveryCost}">
            <div class="shipping tc-os-subtotal-delivery">
    ...
    <div class="tc-os-totals-container">
        <div class="totals tc-os-total">
        ...
        <c:if test="${not cartData.net}">
            <div class="realTotals tc-os-taxes">
                <ycommerce:testId code="cart_taxes_label">
                    <p>
                        <spring:theme code="basket.page.totals.grossTax" arguments="${cartData.totalTax.formattedValue}"
                                      argumentSeparator="!!!!"/>
                    </p>
                </ycommerce:testId>
            </div>
