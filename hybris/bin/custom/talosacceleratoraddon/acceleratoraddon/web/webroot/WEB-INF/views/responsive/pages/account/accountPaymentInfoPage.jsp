...
<div class="container-fluid tc-container">
    <div class="tc-account-payment-info-wp">
        <h3><spring:theme code="text.account.paymentDetails"/></h3>
        <c:choose>
        <c:when test="${not empty paymentInfoData}">
        <div class="tc-account-cards">
            <c:forEach items="${paymentInfoData}" var="paymentInfo">

                <div class="tc-account-card">
                    <ul>
                        <li class="<c:if test="${paymentInfo.defaultPaymentInfo}">tc-account-card-default</c:if> tc-account-card-tittle">
                    ...
                    <ycommerce:testId code="paymentDetails_deletePayment_button">
                        <a class="tc-account-card-icon-cross action-links removePaymentDetailsButton" href="#"
                    ...
                    <c:if test="${not paymentInfo.defaultPaymentInfo}">
                        ...
                        <form:form id="setDefaultPaymentDetails${fn:escapeXml(paymentInfo.id)}"
                                   action="${setDefaultPaymentActionUrl}" method="post"
                                   cssClass="tc-account-card-set-default-btn">
                ...
                <div class="tc-popup-hidden">
                    <div id="popup_confirm_payment_removal_${fn:escapeXml(paymentInfo.id)}"
                        ...
                        <form:form id="removePaymentDetails${fn:escapeXml(paymentInfo.id)}"
