 ...
 */
package com.talos.utrend.backoffice.jalo;
...
import com.talos.utrend.backoffice.constants.UtrendbackofficeConstants;
 ...
 */
public class UtrendbackofficeManager extends GeneratedUtrendbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(UtrendbackofficeManager.class.getName());
	 ...
	 */
	public static UtrendbackofficeManager getInstance()
	{
		return (UtrendbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UtrendbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UtrendbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UtrendbackofficeManager called.");
		}
	}
