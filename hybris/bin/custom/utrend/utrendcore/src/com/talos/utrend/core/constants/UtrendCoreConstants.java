 ...
 */
package com.talos.utrend.core.constants;

/**
 * Global class for all UtrendCore constants. You can add global constants for your extension into this class.
 */
public final class UtrendCoreConstants extends GeneratedUtrendCoreConstants
{
	public static final String EXTENSIONNAME = "utrendcore";


	private UtrendCoreConstants()
	{
		//empty
	}
