 ...
 */
package com.talos.utrend.cockpits.setup;
...
import com.talos.utrend.cockpits.constants.UtrendCockpitsConstants;
 ...
 */
@SystemSetup(extension = UtrendCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(UtrendCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(UtrendCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						UtrendCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/utrendcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
