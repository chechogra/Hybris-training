 ...
 */
package com.talos.utrend.test.setup;
...
import com.talos.utrend.test.constants.UtrendTestConstants;
import com.talos.utrend.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = UtrendTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/utrendtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/utrendtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/utrendtest/import/cstickets.impex");
			...
			importImpexFile(context, "/utrendtest/import/csquotes.impex");
		}
	}
}
