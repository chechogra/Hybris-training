 ...
 */
package com.talos.utrend.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(UtrendFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(UtrendFulfilmentProcessConstants.PARENT_PROCESS);
